...
"Master Shrine": professions_group.Professions_Group("Master Shrine", social_groups["Religious"], 1, 0, 0, 0,
                5, 1, 1, 1, [], [], [professions["Acolyte"], professions["Priest"]], [1]), 
...
"Farmer": building_kind.Building_Kind("Farmer", 0, 8, [professions_groups["Master Food"]]), 
"Commoner": building_kind.Building_Kind("Commoner", 0, 3, [professions_groups["Master Commoner"]]), 
"Bourgeois": building_kind.Building_Kind("Bourgeois", 500, 2, [professions_groups["Master Bourgeois"], professions_groups["Maid Few"]]), 
"Noble": building_kind.Building_Kind("Noble", 1000, 1, [professions_groups["Master Noble"], professions_groups["Maid Some"], professions_groups["Guard Few"]]), 
"Tavern": building_kind.Building_Kind("Tavern", 250, 5, [professions_groups["Master Tavern"], professions_groups["Maid Few"]]), 
"Inn": building_kind.Building_Kind("Inn", 750, 2, [professions_groups["Master Inn"], professions_groups["Maid Some"]]), 
"Hospital": building_kind.Building_Kind("Hospital", 1500, 1, [professions_groups["Master Hospital"], professions_groups["Hospital Employee"]]), 
"Bank": building_kind.Building_Kind("Bank", 5000, 1, [professions_groups["Master Bank"], professions_groups["Guard Some"]]), 
"General Store": building_kind.Building_Kind("General Store", 500, 5, [professions_groups["Master General Store"]]), 
"Luxury Store": building_kind.Building_Kind("Luxury Store", 1500, 1, [professions_groups["Master Luxury Store"], professions_groups["Guard Few"]]), 
"Blacksmith": building_kind.Building_Kind("Blacksmith", 200, 2, [professions_groups["Master Blacksmith"], professions_groups["Apprentice Few"], professions_groups["Tenter Some"]]), 
"Tailor": building_kind.Building_Kind("Tailor", 0, 3, [professions_groups["Master Tailor"], professions_groups["Apprentice Few"], professions_groups["Tenter Few"]]), 
"Leatherwork": building_kind.Building_Kind("Leatherwork", 0, 3, [professions_groups["Master Leatherwork"], professions_groups["Apprentice Few"], professions_groups["Tenter Few"]]), 
"Woodwork": building_kind.Building_Kind("Woodwork", 0, 2, [professions_groups["Master Woodwork"], professions_groups["Apprentice Few"], professions_groups["Tenter Some"]]), 
"Builder": building_kind.Building_Kind("Builder", 500, 2, [professions_groups["Master Builder"], professions_groups["Apprentice Some"], professions_groups["Tenter Many"]]), 
"Misc Workshop": building_kind.Building_Kind("Misc Workshop", 1000, 1, [professions_groups["Master Misc Workshop"], professions_groups["Apprentice Few"], professions_groups["Tenter Few"]]), 
"Keep": building_kind.Building_Kind("Keep", 0, 0, [professions_groups["Master Stronghold"], professions_groups["Maid Some"], professions_groups["Guard Some"]]), 
"Castle (Small)": building_kind.Building_Kind("Castle (Small)", 1000, 0, [professions_groups["Master Stronghold"], professions_groups["Maid Some"], professions_groups["Guard Some"]]), 
"Castle (Large)": building_kind.Building_Kind("Castle (Large)", 8000, 0, [professions_groups["Master Stronghold"], professions_groups["Maid Many"], professions_groups["Guard Many"]]), 
