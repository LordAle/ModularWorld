...
cultures = {"Human": culture.Culture("Human", races["Human"], [], "Patriarchal", 20, ["Halfling", "Half-Elven", "Half-Orcish", "Dwarven", "Gnomish", "Elven"], [8,4,3,1,1,1]), 
...
"Half-Orcish": culture.Culture("Half-Orcish", races["Half-Orc"], ["Altruism-0.2", "Order-0.2"], "Patriarchal", 10, ["Human"], [1,1,1,1,1]), 
} 
...
building_kinds = {"Farmer": building_kind.Building_Kind("Farmer", 0, 8, 1, 1, 1, [], [], []), 
"Commoner": building_kind.Building_Kind("Commoner", 0, 3, 1, 1, 1, [], [], []), 
"Bourgeois": building_kind.Building_Kind("Bourgeois", 500, 2, 1, 1, 1, [], [], []), 
"Noble": building_kind.Building_Kind("Noble", 1000, 1, 1, 1, 1, [], [], []), 
"Tavern": building_kind.Building_Kind("Tavern", 250, 5, 1, 1, 1, [], [], []), 
"Inn": building_kind.Building_Kind("Inn", 750, 2, 1, 1, 1, [], [], []), 
"Hospital": building_kind.Building_Kind("Hospital", 1500, 1, 1, 1, 1, [], [], []), 
"Bank": building_kind.Building_Kind("Bank", 5000, 1, 1, 1, 1, [], [], []), 
"General Store": building_kind.Building_Kind("General Store", 500, 5, 1, 1, 1, [], [], []), 
"Luxury Store": building_kind.Building_Kind("Luxury Store", 1500, 1, 1, 1, 1, [], [], []), 
"Blacksmith": building_kind.Building_Kind("Blacksmith", 200, 2, 1, 1, 1, [], [], []), 
"Tailor": building_kind.Building_Kind("Tailor", 0, 3, 1, 1, 1, [], [], []), 
"Leatherwork": building_kind.Building_Kind("Leatherwork", 0, 3, 1, 1, 1, [], [], []), 
"Woodwork": building_kind.Building_Kind("Woodwork", 0, 2, 1, 1, 1, [], [], []), 
"Builder": building_kind.Building_Kind("Builder", 500, 2, 1, 1, 1, [], [], []), 
"Misc Workshop": building_kind.Building_Kind("Misc Workshop", 1000, 1, 1, 1, 1, [], [], []), 
"Keep": building_kind.Building_Kind("Keep", 0, 0, 1, 1, 1, [], [], []), 
"Castle (Small)": building_kind.Building_Kind("Castle (Small)", 1000, 0, 1, 1, 1, [], [], []), 
"Castle (Large)": building_kind.Building_Kind("Castle (Large)", 8000, 0, 1, 1, 1, [], [], []), 
"Shrine": building_kind.Building_Kind("Shrine", 0, 5, 0, 0, 0, [], [], []), 
"Church": building_kind.Building_Kind("Church", 1000, 2, 0, 0, 0, [], [], []), 
"Cathedral": building_kind.Building_Kind("Cathedral", 8000, 1, 0, 0, 0, [], [], []), 
"School": building_kind.Building_Kind("School", 1000, 5, 0, 0, 0, [], [], []), 
"University": building_kind.Building_Kind("University", 8000, 1, 0, 0, 0, [], [], []), 
"Prison": building_kind.Building_Kind("Prison", 500, 5, 0, 0, 0, [], [], []), 
"Barrack": building_kind.Building_Kind("Barrack", 1000, 5, 0, 0, 0, [], [], []), 
"Fortress": building_kind.Building_Kind("Fortress", 8000, 1, 0, 0, 0, [], [], []), 
"Thieves Den": building_kind.Building_Kind("Thieves Den", 1000, 1, 0, 0, 0, [], [], []), 
"Criminal Front": building_kind.Building_Kind("Criminal Front", 1000, 1, 0, 0, 0, [], [], []), 
"Artists Guild": building_kind.Building_Kind("Artists Guild", 1000, 5, 0, 0, 0, [], [], []), 
"Circus": building_kind.Building_Kind("Circus", 3000, 2, 0, 0, 0, [], [], []), 
"Museum": building_kind.Building_Kind("Museum", 8000, 1, 0, 0, 0, [], [], []), 
"Homeless": building_kind.Building_Kind("Homeless", 0, 0, 0, 0, 0, [], [], []), 
} 

social_groups = {"Noble": social_group.Social_Group("Noble", 1, 0, 0, "", "", [], [], []), 
"Bourgeois": social_group.Social_Group("Bourgeois", 0, 1, 3, "", ">0.4", [], [], [cultures["Human"], cultures["Elven"], cultures["Dwarven"]]), 
"Commoner": social_group.Social_Group("Commoner", 0, 2, 0, "", "<0.4", [], [], []), 
"Farmer": social_group.Social_Group("Farmer", 0, 3, 1, "", "<0.4", [], [], []), 
"Craftsman": social_group.Social_Group("Craftsman", 0, 2, 2, "", ">0.2", ["Dexterity>9"], [], []), 
"Scholar": social_group.Social_Group("Scholar", 0, 1, 3, "", ">0.3", ["Intelligence>12"], [], []), 
"Religious": social_group.Social_Group("Religious", 0, 2, 1, "", "", ["Wisdom>11"], [], []), 
"Criminal": social_group.Social_Group("Criminal", 0, 1, 1, "", "", [], ["Altruism<0"], []), 
"Artist": social_group.Social_Group("Artist", 0, 1, 2, "", "", ["Charisma>11"], [], []), 
"Military": social_group.Social_Group("Military", 0, 2, 3, "Male", ">0.2", ["Strength>11", "Constitution>9"], ["Order>0"], []), 
"Outsider": social_group.Social_Group("Outsider", 0, 0, 0, "", "", [], [], []), 
"Monster": social_group.Social_Group("Monster", 1, 0, 0, "", "", [], [], []), 
} 

professions = {"Burgomeister": profession.Profession("Burgomeister", 0.4, "", 1), 
