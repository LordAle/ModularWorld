...
attributes = (attribute.Attribute("Strength", "Triangular", [8,19,10]), 
attribute.Attribute("Dexterity", "Triangular", [8,19,10]), 
attribute.Attribute("Constitution", "Triangular", [8,19,10]), 
attribute.Attribute("Intelligence", "Triangular", [8,19,10]), 
attribute.Attribute("Wisdom", "Triangular", [8,19,10]), 
attribute.Attribute("Charisma", "Triangular", [8,19,10]), 
) 

moralities = (morality.Morality("Altruism", [-1,1], 0, 1, 0, 0.2), 
morality.Morality("Order", [-1,1], 0, 1, 0, 0.2), 
morality.Morality("Path", [0,11], 1, 0, 5, 1), 
) 
...
professions_groups = {"Master Food": professions_group.Professions_Group("Master Food", 1, social_groups["Farmer"], "One", [1], [professions["Farmer"], professions["Fisherman"], professions["Herder"]], [10,10,5]), 
"Master Commoner": professions_group.Professions_Group("Master Commoner", 1, social_groups["Commoner"], "One", [1], [professions["Barber"], professions["Ferryman"], professions["Gravedigger"], professions["Midwife"], professions["Raker"], professions["Water Carrier"]], [1,1,1,1,1,1]), 
"Master Bourgeois": professions_group.Professions_Group("Master Bourgeois", 1, social_groups["Bourgeois"], "One", [1], [professions["Animal Keeper"], professions["Bather"], professions["Burgomeister"], professions["Doctor"], professions["Miller"]], [2,1,5,2,3]), 
"Master Noble": professions_group.Professions_Group("Master Noble", 1, social_groups["Noble"], "One", [1], [professions["Diplomat"], professions["Knight"], professions["Noble"], professions["Chancellor"], professions["Constable"], professions["Exchequer"], professions["Forester"]], [1,2,2,3,3,3,3]), 
"Master Tavern": professions_group.Professions_Group("Master Tavern", 1, social_groups["Commoner"], "One", [1], [professions["Cook"]], [1]), 
"Master Inn": professions_group.Professions_Group("Master Inn", 1, social_groups["Bourgeois"], "One", [1], [professions["Innkeeper"]], [1]), 
"Master Hospital": professions_group.Professions_Group("Master Hospital", 1, social_groups["Bourgeois"], "One", [1], [professions["Doctor"]], [1]), 
"Master Bank": professions_group.Professions_Group("Master Bank", 1, social_groups["Bourgeois"], "One", [1], [professions["Banker"]], [1]), 
"Master General Store": professions_group.Professions_Group("Master General Store", 1, social_groups["Commoner"], "One", [1], [professions["Merchant"]], [1]), 
"Master Luxury Store": professions_group.Professions_Group("Master Luxury Store", 1, social_groups["Bourgeois"], "One", [1], [professions["Merchant"]], [1]), 
"Master Blacksmith": professions_group.Professions_Group("Master Blacksmith", 1, social_groups["Craftsman"], "One", [1], [professions["Blacksmith"]], [1]), 
"Master Tailor": professions_group.Professions_Group("Master Tailor", 1, social_groups["Craftsman"], "One", [1], [professions["Tailor"]], [1]), 
"Master Leatherwork": professions_group.Professions_Group("Master Leatherwork", 1, social_groups["Craftsman"], "One", [1], [professions["Leatherworker"]], [1]), 
"Master Woodwork": professions_group.Professions_Group("Master Woodwork", 1, social_groups["Craftsman"], "One", [1], [professions["Woodworker"]], [1]), 
"Master Builder": professions_group.Professions_Group("Master Builder", 1, social_groups["Craftsman"], "One", [1], [professions["Builder"]], [1]), 
"Master Misc Workshop": professions_group.Professions_Group("Master Misc Workshop", 1, social_groups["Craftsman"], "One", [1], [professions["Specialist Craftsman"]], [1]), 
"Master Stronghold": professions_group.Professions_Group("Master Stronghold", 1, social_groups["Noble"], "One", [1], [professions["Local Lord"]], [1]), 
"Master Shrine": professions_group.Professions_Group("Master Shrine", 1, social_groups["Religious"], "One", [1], [professions["Acolyte"], professions["Priest"]], [1]), 
"Master Church": professions_group.Professions_Group("Master Church", 1, social_groups["Religious"], "One", [1], [professions["Priest"]], [1]), 
"Master Cathedral": professions_group.Professions_Group("Master Cathedral", 1, social_groups["Religious"], "One", [1], [professions["High Priest"]], [1]), 
"Master School": professions_group.Professions_Group("Master School", 1, social_groups["Scholar"], "One", [1], [professions["Scholar"]], [1]), 
"Master University": professions_group.Professions_Group("Master University", 1, social_groups["Scholar"], "One", [1], [professions["Scholar"]], [1]), 
"Master Prison": professions_group.Professions_Group("Master Prison", 1, social_groups["Military"], "One", [1], [professions["Guard"]], [1]), 
"Master Barrack": professions_group.Professions_Group("Master Barrack", 1, social_groups["Military"], "One", [1], [professions["Soldier"]], [1]), 
"Master Fortress": professions_group.Professions_Group("Master Fortress", 1, social_groups["Military"], "One", [1], [professions["Soldier"]], [1]), 
"Master Thieves Den": professions_group.Professions_Group("Master Thieves Den", 1, social_groups["Criminal"], "One", [1], [professions["Thief"]], [1]), 
"Master Criminal Front": professions_group.Professions_Group("Master Criminal Front", 1, social_groups["Criminal"], "One", [1], [professions["Thief"]], [1]), 
"Master Artists Guild": professions_group.Professions_Group("Master Artists Guild", 1, social_groups["Artist"], "One", [1], [professions["Artist"]], [1]), 
"Master Circus": professions_group.Professions_Group("Master Circus", 1, social_groups["Artist"], "One", [1], [professions["Artist"]], [1]), 
"Master Museum": professions_group.Professions_Group("Master Museum", 1, social_groups["Scholar"], "One", [1], [professions["Scholar"]], [1]), 
"Maid Few": professions_group.Professions_Group("Maid Few", 0, social_groups["Servant"], "Normal", [2,1], [professions["Maid"]], [1]), 
"Maid Some": professions_group.Professions_Group("Maid Some", 0, social_groups["Servant"], "Normal", [5,1], [professions["Maid"]], [1]), 
"Maid Many": professions_group.Professions_Group("Maid Many", 0, social_groups["Servant"], "Normal", [10,2], [professions["Maid"]], [1]), 
"Guard Few": professions_group.Professions_Group("Guard Few", 0, social_groups["Military"], "Normal", [2,1], [professions["Guard"]], [1]), 
"Guard Some": professions_group.Professions_Group("Guard Some", 0, social_groups["Military"], "Normal", [5,1], [professions["Guard"]], [1]), 
"Guard Many": professions_group.Professions_Group("Guard Many", 0, social_groups["Military"], "Normal", [10,2], [professions["Guard"]], [1]), 
"Apprentice Few": professions_group.Professions_Group("Apprentice Few", 0, social_groups["Craftsman"], "Normal", [1,1], [professions["Apprentice"]], [1]), 
"Apprentice Some": professions_group.Professions_Group("Apprentice Some", 0, social_groups["Craftsman"], "Normal", [3,1], [professions["Apprentice"]], [1]), 
"Apprentice Many": professions_group.Professions_Group("Apprentice Many", 0, social_groups["Craftsman"], "Normal", [5,1], [professions["Apprentice"]], [1]), 
"Tenter Few": professions_group.Professions_Group("Tenter Few", 0, social_groups["Craftsman"], "Normal", [2,1], [professions["Tenter"]], [1]), 
"Tenter Some": professions_group.Professions_Group("Tenter Some", 0, social_groups["Craftsman"], "Normal", [5,1], [professions["Tenter"]], [1]), 
"Tenter Many": professions_group.Professions_Group("Tenter Many", 0, social_groups["Craftsman"], "Normal", [10,2], [professions["Tenter"]], [1]), 
"Hospital Employee": professions_group.Professions_Group("Hospital Employee", 0, social_groups["Commoner"], "Normal", [4,2], [professions["Cook"], professions["Midwife"], professions["Water Carrier"]], [1,3,1]), 
"Acolyte Few": professions_group.Professions_Group("Acolyte Few", 0, social_groups["Religious"], "Normal", [3,1], [professions["Acolyte"]], [1]), 
"Priest Few": professions_group.Professions_Group("Priest Few", 0, social_groups["Religious"], "Normal", [2,1], [professions["Priest"]], [1]), 
"Scholar Many": professions_group.Professions_Group("Scholar Many", 0, social_groups["Scholar"], "Normal", [10,2], [professions["Scholar"]], [1]), 
"Thief Some": professions_group.Professions_Group("Thief Some", 0, social_groups["Criminal"], "Normal", [6,2], [professions["Thief"]], [1]), 
"Artist Some": professions_group.Professions_Group("Artist Some", 0, social_groups["Artist"], "Normal", [4,1], [professions["Artist"]], [1]), 
} 

building_kinds = {"Error": building_kind.Building_Kind("Error", 0, 0, 0, 0, 0, [], [], []), 
"Default": building_kind.Building_Kind("Default", 0, 0, 0, 0, 0, [], [], []), 
"Farmer": building_kind.Building_Kind("Farmer", 0, 8, 1, 4, 1, [professions_groups["Master Food"]], [], []), 
"Commoner": building_kind.Building_Kind("Commoner", 0, 3, 1, 4, 1, [professions_groups["Master Commoner"]], [], []), 
"Bourgeois": building_kind.Building_Kind("Bourgeois", 500, 2, 1, 3, 1, [professions_groups["Master Bourgeois"]], [], [professions_groups["Maid Few"]]), 
"Noble": building_kind.Building_Kind("Noble", 1000, 1, 1, 4, 1, [professions_groups["Maid Some"], professions_groups["Guard Few"]], [professions_groups["Master Noble"]], []), 
"Tavern": building_kind.Building_Kind("Tavern", 250, 5, 1, 4, 1, [professions_groups["Master Tavern"]], [], [professions_groups["Maid Few"]]), 
"Inn": building_kind.Building_Kind("Inn", 750, 2, 1, 3, 1, [professions_groups["Master Inn"], professions_groups["Maid Some"]], [], []), 
"Hospital": building_kind.Building_Kind("Hospital", 1500, 1, 1, 3, 1, [professions_groups["Master Hospital"]], [], [professions_groups["Hospital Employee"]]), 
"Bank": building_kind.Building_Kind("Bank", 5000, 1, 1, 3, 1, [professions_groups["Master Bank"]], [], [professions_groups["Guard Some"]]), 
"General Store": building_kind.Building_Kind("General Store", 500, 5, 1, 3, 1, [professions_groups["Master General Store"]], [], []), 
"Luxury Store": building_kind.Building_Kind("Luxury Store", 1500, 1, 1, 3, 1, [professions_groups["Master Luxury Store"]], [], [professions_groups["Guard Few"]]), 
"Blacksmith": building_kind.Building_Kind("Blacksmith", 200, 2, 1, 4, 1, [professions_groups["Master Blacksmith"], professions_groups["Apprentice Few"]], [], [professions_groups["Tenter Some"]]), 
"Tailor": building_kind.Building_Kind("Tailor", 0, 3, 1, 4, 1, [professions_groups["Master Tailor"], professions_groups["Apprentice Few"]], [], [professions_groups["Tenter Few"]]), 
"Leatherwork": building_kind.Building_Kind("Leatherwork", 0, 3, 1, 4, 1, [professions_groups["Master Leatherwork"], professions_groups["Apprentice Few"]], [], [professions_groups["Tenter Few"]]), 
"Woodwork": building_kind.Building_Kind("Woodwork", 0, 2, 1, 4, 1, [professions_groups["Master Woodwork"], professions_groups["Apprentice Few"]], [], [professions_groups["Tenter Some"]]), 
"Builder": building_kind.Building_Kind("Builder", 500, 2, 1, 4, 1, [professions_groups["Master Builder"], professions_groups["Apprentice Some"]], [], [professions_groups["Tenter Many"]]), 
"Misc Workshop": building_kind.Building_Kind("Misc Workshop", 1000, 1, 1, 4, 1, [professions_groups["Master Misc Workshop"], professions_groups["Apprentice Few"]], [], [professions_groups["Tenter Few"]]), 
"Keep": building_kind.Building_Kind("Keep", 0, 0, 1, 4, 1, [professions_groups["Master Stronghold"], professions_groups["Maid Some"], professions_groups["Guard Some"]], [], []), 
"Castle (Small)": building_kind.Building_Kind("Castle (Small)", 1000, 0, 1, 4, 1, [professions_groups["Master Stronghold"], professions_groups["Maid Some"], professions_groups["Guard Some"]], [], []), 
"Castle (Large)": building_kind.Building_Kind("Castle (Large)", 8000, 0, 1, 4, 1, [professions_groups["Master Stronghold"], professions_groups["Maid Many"], professions_groups["Guard Many"]], [], []), 
"Shrine": building_kind.Building_Kind("Shrine", 0, 5, 0, 0, 0, [professions_groups["Master Shrine"]], [], []), 
"Church": building_kind.Building_Kind("Church", 1000, 2, 0, 0, 0, [professions_groups["Master Church"], professions_groups["Acolyte Few"]], [], []), 
"Cathedral": building_kind.Building_Kind("Cathedral", 8000, 1, 0, 0, 0, [professions_groups["Master Cathedral"], professions_groups["Acolyte Few"], professions_groups["Priest Few"]], [], []), 
"School": building_kind.Building_Kind("School", 1000, 5, 0, 0, 0, [professions_groups["Master School"]], [], []), 
"University": building_kind.Building_Kind("University", 8000, 1, 0, 0, 0, [professions_groups["Master University"], professions_groups["Scholar Many"]], [], []), 
"Prison": building_kind.Building_Kind("Prison", 500, 5, 0, 0, 0, [], [], [professions_groups["Master Prison"], professions_groups["Guard Some"]]), 
"Barrack": building_kind.Building_Kind("Barrack", 1000, 5, 0, 0, 0, [professions_groups["Master Barrack"], professions_groups["Guard Many"]], [], []), 
"Fortress": building_kind.Building_Kind("Fortress", 8000, 1, 0, 0, 0, [professions_groups["Master Fortress"], professions_groups["Guard Many"]], [], []), 
"Thieves Den": building_kind.Building_Kind("Thieves Den", 1000, 1, 0, 0, 0, [professions_groups["Master Thieves Den"], professions_groups["Thief Some"]], [], []), 
"Criminal Front": building_kind.Building_Kind("Criminal Front", 1000, 1, 0, 2, 0, [professions_groups["Master Criminal Front"]], [], []), 
"Artists Guild": building_kind.Building_Kind("Artists Guild", 1000, 5, 0, 0, 0, [professions_groups["Master Artists Guild"], professions_groups["Artist Some"]], [], []), 
"Circus": building_kind.Building_Kind("Circus", 3000, 2, 0, 0, 0, [professions_groups["Master Circus"], professions_groups["Artist Some"]], [], []), 
"Museum": building_kind.Building_Kind("Museum", 8000, 1, 0, 0, 0, [professions_groups["Master Museum"]], [], [professions_groups["Guard Few"]]), 
"Homeless": building_kind.Building_Kind("Homeless", 0, 0, 0, 0, 0, [], [], []), 
} 
