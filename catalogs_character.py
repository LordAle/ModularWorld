...
#All lists ordering matters for generating weighted lists
...
#ages = ['Baby', 'Child', 'Teen', 'Young Adult', 'Adult', 'Middleaged', 'Senior', 'Elderly']
ages = {'Dwarf':(25,150),'Elf':(30,200),'Halfling':(20,100),'Human':(16,80),'Gnome':(22,120),'Half-Elf':(22,120),
        'Half-Orc':(14,70)}

wealth = ['Poor', 'Middle', 'Rich']

profession_governance = ['Catchpole','Chancellor','Diplomat','Exchequer','Forester','Hayward','Herald','Judge','Knight','Liner',
                         'Local Lord', 'Nobleman(woman)','Summoner']
