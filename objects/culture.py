...
class Culture:
    ...
    def __init__(self, name, race, morality_modifiers, gender_equality, cultural_openness, other_cultures =[], other_cultures_odds=[]):
        ...
        self.other_cultures = other_cultures  # A list of String that are the Keys to other cultures in catalog.cultures
        self.odds = other_cultures_odds  # A list of integer used to weight the proportion of each cultures other than the main one in the city
        ...
        if len(self.other_cultures) != len(self.odds):  # Sends warning message if a error is found in the catalogs csv files
